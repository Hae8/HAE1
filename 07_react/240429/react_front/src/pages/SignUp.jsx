        ...
        <>
            ...
            >
                ...
                <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
                    <Button type='suibmit' variant="contained" color="mainColor" sx={{ display: 'block', width: '49%', color: "#f2f2f2" }}>회원가입</Button>
                    <Button variant="contained" color="mainColor" sx={{ display: 'block', width: '49%', color: "#f2f2f2"}} onClick={(e) => {
                        e.preventDefault()
                        reset();
                    }} >초기화</Button>
                </Box>
