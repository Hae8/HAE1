...
const SignUp = () => {
    ...
    return (
        <>
            <Typography variant="h4" sx={{marginTop:8}}>회원가입</Typography>
            {/* form tag 시작 */}
            <Box
                component="form"
                my={4}
            ...
            >
                ...
                <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
                    <Button type='suibmit' variant="contained" color="mainColor" sx={{ display: 'block', width: '49%' }}>회원가입</Button>
                    <Button variant="contained" color="mainColor" sx={{ display: 'block', width: '49%' }} onClick={(e) => {
                        e.preventDefault()
                        reset();
                    }} >초기화</Button>
                </Box>
